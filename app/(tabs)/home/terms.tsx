...
SCAMLY PTY LTD retains all rights, title, and interest in and to the Application and all related Services. Nothing you do on or in relation to the Application will transfer any:

(a) business name, trading name, domain name, trade mark, industrial design, patent, registered design or copyright, or
(b) a right ot use or exploit a business name, trading name, domain name, trademark or industrial design, or
...
User-Generated Data and Service Improvements
...
(b) the accuracy, suitability or currency of any information on the Application, the Services, or any of its Services related products (including third party materials and advertisements on the Application);
(c) consts incurred as a result of you using the Application, the Services or any of the products of SCAMLY PTY LTD;
...
(a) reliance on any analysis, alert, recommendation or output generated by the Application's AI systems;
(b) the failure of the Application to identify a scam, fraudulent communication or physhing attempt, or;
(c) any inaccurate, incomplete or misleading output produced by the Application.
...
Notwithstanding the foregoing, the limitations in this clause do not apply to liability for:

(a) death or personal injury caused by negligence;
(b) fraud, wilful misconduct or gross negligence;
(c) breach of confidentiality under clause 14.4;
(d) infringement of third-party intellectual property rights; or
